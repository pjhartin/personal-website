  ...
  >
    <div class="container mx-auto md:w-2/3 pl-8 pr-8 mt-24 mb-12">
      <p class="md:text-2xl mb-4">
        Hi, I'm Phillip Hartin,
        <br>thanks for visiting my little slice of the internet.
      </p>
      ...
      >Outside of this role, I'm involved in a number of healthcare research projects on a software consultancy basis, developing mobile apps, web platforms, and all their supporting infrastructures.</p>
      <!-- <p class="md:text-2xl mb-4">
      ...
      <p
        class="md:text-2xl mb-4"
      >These commitments keep me very busy, so I apologise if I'm slow to respond, but if you'd like to get in touch, please reach out to me on one of the following:</p>
    </div>
  </section>
</template>
